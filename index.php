...
<div class="banner">
  <div class="container">
    <div class="banner_info">
      <h3>Find Your Perfect Partner Here!!!</h3>
			   ...
			   <li>
					...
					<div class="suceess_story-content-container">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Raju & Roja</a></h4>				        	
				        	<p>My Life is Beautiful Now!!!</p>
				        </div>
				    </div>
				</li>
	            <li>
					...
					<div class="suceess_story-content-container">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Rahul & Rejina</a></h4>				        	
				        	<p>Happy Life Married Life!!!</p>
				        </div>
				    </div>
				</li>
	            <li>
					...
					<div class="suceess_story-content-container">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Mukesh & swetha</a></h4>				        	
				        	<p>Finding your best partner makes your life complete!!!</a></p>
				        </div>
				    </div>
				</li>
	            <li>
					...
					<div class="suceess_story-content-container">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Suresh & sunaina</a></h4>				        	
				        	<p>Made for each other!!</a></p>
				        </div>
				    </div>
				</li>
	            <li>
					...
					<div class="suceess_story-content-container">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Karthik & Monisha</a></h4>				        	
				        	<p>Truly Blessed!!!</a></p>
				        </div>
				    </div>
				</li>
	            <li>
					...
					<div class="suceess_story-content-container">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Krithik & Kanmani</a></h4>				        	
				        	<p>Entering into their Marraige life made them wonderful!!!</a></p>
				        </div>
				    </div>
				</li>
	            <li>
					...
					<div class="suceess_story-content-container">
						...
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Rajesh & Raasathi</a></h4>				        	
				        	<p>Loving , caring and wonderful couples!!!</p>
				        </div>
				    </div>
				</li>
	        </ul>
	      ...
	      <h3>Latest Profiles</h3>
	        <div class="box_1">
			  ...
			  <div class="extra-wrap">
				...
				<h4 class="post-title"><a href="#">Harish</a></h4>
				<div class="clearfix"> </div>
				<div class="post-content">Will Your Be Mine???</div>
	        ...
	        <div class="box_1">
			  ...
			  <div class="extra-wrap">
				...
				<h4 class="post-title"><a href="#">Sanjay</a></h4>
				<div class="clearfix"> </div>
				<div class="post-content">Waiting for my cutie pie!!!</div>
				<a href="#" class="vertical">Read More</a>
			  </div>
	        </div>
	        <div class="box_2">
			  ...
			  <div class="extra-wrap">
				...
				<h4 class="post-title"><a href="#">Jagadeesh</a></h4>
				<div class="clearfix"> </div>
				<div class="post-content">My wife My Life!!!</div>
				<a href="#" class="vertical">Read More</a>
			  </div>
	        </div>
	        <div class="religion">
	        ...
	        <div class="religion">
			   ...
			   <a href="#" target="_blank" class="religion_1" title="Hindu Matrimonial" style="padding-left:0px !important;">Tamil</a>
		...
		<div class="container"> 
            ...
            <div class="col-sm-6">
            	<div class="bg_left">
            		...
            		<p>His life is wonderful because of her and most importantly the way that led him to find her that is this service , thank you!!!</p>
            ...
            <div class="col-sm-6">
            	<div class="bg_left">
            		...
            		<p>"He made her Happy , she will be happy rest of her life!!!</p>
            	   <ul class="team-socials">
                    <li><a href="#"><span class="icon-social "><i class="fa fa-facebook"></i></span></a></li>
                    <li><a href="#"><span class="icon-social "><i class="fa fa-twitter"></i></span></a></li>
                    <li><a href="#"><span class="icon-social"><i class="fa fa-google-plus"></i></span></a></li>
