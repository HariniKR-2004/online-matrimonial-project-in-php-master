				    ...
				    <div class="basic_1-left">
				    	  <table class="table_working_hours">
				        	<tbody>
								...
								<tr class="opened">
									<td class="day_label">Height(cm):</td>
									<td class="day_value closed"><input type="text"  id="edit-name" name="height" value="<?php echo $height;?>" size="60" maxlength="60" class="form-text"></td>
								</tr>
								<tr class="opened">
