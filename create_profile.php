...
<div class="grid_3">
		     ...
		     <div class="form-group col-sm-2">
		      <label for="edit-name">Sex <span class="form-required" title="This field is required.">*</span></label>
			    <div class="select-block1">
	                <select name="sex">
						<option value="no option">Gender</option>
 ...
 Date Of Birth <span class="form-required" title="This field is required."></span></label>
			...
			<div class="form-group col-sm-6">
				<div class="age_select">
					<div class="age_grid">
						<div class="col-sm-4 form_box">
							...
							<div class="select-block1">
								<select name="religion">
									<option value="Not Applicable">Religion</option>
						...
						<div class="col-sm-4 form_box">
							<label for="edit-pass">Caste*</label>
							<div class="select-block1">
								<select name="caste">
						...
						<div class="col-sm-4 form_box">
							<label for="edit-pass">Subcaste</label>
							<div class="select-block1">
		      ...
		      <label for="edit-name">Mother Tongue<span class="form-required" title="This field is required.">*</span></label>
			    <div class="select-block1">
	                <select name="mothertounge">
						<option value="Mother Tounge">Mother Tongue</option>
		    ...
		    <div class="form-group col-sm-2">
		      <label for="edit-name">Annual Income(INR)<span class="form-required" title="This field is required.">*</span></label>
